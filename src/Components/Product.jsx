    ...
    <>
      ...
      >
        ...
        <div className="mx-4 md:mx-auto md:flex-row flex flex-col justify-center items-center md:gap-10 gap-8">
          <div className="bg-white md:w-[360px] md:h-[400px] box-border rounded-md shadow-lg hover:shadow-xl flex flex-col items-center justify-start text-center border border-orange-100 px-7 pt-10 pb-14">
          ...
          <div className="bg-white md:w-[360px] md:h-[400px] box-border rounded-md shadow-lg hover:shadow-xl flex flex-col items-center justify-start text-center border border-orange-100 px-7 pt-10 pb-14">
            <TbFile className="md:size-[88px] size-[70px] border border-orange-600 text-orange-600 p-3 rounded-full mb-5" />
            ...
            <button className="border border-orange-600 font-bold md:text-xl px-5 py-2 text-lg rounded-full hover:bg-orange-600 hover:text-white duration-300">
              <a href="/surat-lamaran">Buat Surat Lamaran</a>
            </button>
          </div>
          <div className="bg-white md:w-[360px] md:h-[400px] box-border rounded-md shadow-lg hover:shadow-xl flex flex-col items-center justify-start text-center border border-orange-100 px-7 pt-10 pb-14">
            <TbFileBroken className="md:size-[88px] size-[70px] border border-orange-600 text-orange-600 p-3 rounded-full mb-5" />
